      ...
      <form action="kadai10_2.php" method="POST" novalidate>
        <div class="p-5 row">
          <div class="col-md-5">
            ...
            <!-- 商品番号 -->
            <div class="col">
              <label class="form-label" for="product_no">商品番号<em class="text-danger">※必須</em></label>
              <input type="text" name="product_no" id="product_no" class="form-control form-control-lg border-info" placeholder="" required>
            </div>
